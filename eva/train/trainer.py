...
# Base class for act_trainer and seq_trainer
class Trainer:
    ...
    def __init__(self, model, optimizer, batch_size, get_batch, loss_fn, scheduler=None, eval_fns=None):
        ...
        self.get_batch = get_batch # a function
    ...
    def train_step(self):
        ...
        # loss is computed on prediction of (s,a,r), but state_target and reward_target index is currently wrong
        loss = self.loss_fn(
